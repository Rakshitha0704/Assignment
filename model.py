...
Original file is located at
    https://colab.research.google.com/drive/1ifYxn59V1hw6I-67DNBCsjuqxJi4Bqwf
"""
...
if __name__ == "__main__":
    ...
    # Predict for a specific image (e.g., the first test image)
    ...
    img = X_test[0].reshape(32, 32, 3)  # Reshape back to image size for display
    plt.imshow(img)
